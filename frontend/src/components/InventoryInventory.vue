    ...
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                ...
                color="primary"
                text
                @click="openIncreaseCommand"
            >
                IncreaseCommand
            </v-btn>
            <v-dialog v-model="increaseCommandDiagram" width="500">
                <IncreaseCommandCommand
                    @closeDialog="closeIncreaseCommand"
